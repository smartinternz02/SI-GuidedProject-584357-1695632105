    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            COS_API_KEY_ID = "SBl3gpTkLCzgFg81mqqss-GSTlqFGILYEU5owFX8e3H1"
            COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/31e69dc48cf241358331249be8b4fc0a:1e7c9116-27ca-4ccd-aec0-eec4eefa4050::"
